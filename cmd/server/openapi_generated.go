...
func registerBootConfigurationPaths(spec *openapi3.T) {
	...
	resourceSchema, _ := openapi3gen.NewSchemaRefForValue(&bootconfiguration.BootConfiguration{}, spec.Components.Schemas)
...
func registerNodePaths(spec *openapi3.T) {
	// Generate schemas from Go types - NO ANNOTATIONS NEEDED
	resourceSchema, _ := openapi3gen.NewSchemaRefForValue(&node.Node{}, spec.Components.Schemas)
