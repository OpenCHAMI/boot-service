// Code generated by Fabrica v0.4.4-9-g4df0460 (commit: 4df0460). DO NOT EDIT.
// Template: server/handlers.go.tmpl
// Generated: 2026-05-11T16:34:21Z
//
...
func CreateBootConfiguration(w http.ResponseWriter, r *http.Request) {
	...
	bootConfiguration := &v1.BootConfiguration{
	...
	bootConfiguration.Metadata = req.Metadata
	bootConfiguration.Metadata.UID = uid
	now := time.Now()
	bootConfiguration.Metadata.CreatedAt = now
	bootConfiguration.Metadata.UpdatedAt = now

	// Set labels and annotations
	if bootConfiguration.Metadata.Labels == nil {
		bootConfiguration.Metadata.Labels = make(map[string]string)
	}
	for k, v := range req.Labels {
		bootConfiguration.Metadata.Labels[k] = v
	}
	if bootConfiguration.Metadata.Annotations == nil {
		bootConfiguration.Metadata.Annotations = make(map[string]string)
	}
	for k, v := range req.Annotations {
		bootConfiguration.Metadata.Annotations[k] = v
	}
	...
	if err := events.PublishResourceCreated(r.Context(), "BootConfiguration", bootConfiguration.Metadata.UID, bootConfiguration.Metadata.Name, bootConfiguration); err != nil {
		// Log the error but don't fail the request - events are non-critical
		fmt.Printf("Warning: Failed to publish resource created event for BootConfiguration %s: %v\n", bootConfiguration.Metadata.UID, err)
...
func UpdateBootConfiguration(w http.ResponseWriter, r *http.Request) {
	...
	if req.Metadata.Name != "" {
		bootConfiguration.Metadata.Name = req.Metadata.Name
	}

	// Update spec fields ONLY - status should use /status subresource
	bootConfiguration.Spec = req.AsSpec()
	...
	// Update timestamp
	bootConfiguration.Metadata.UpdatedAt = time.Now()
	...
	if err := events.PublishResourceUpdated(r.Context(), "BootConfiguration", bootConfiguration.Metadata.UID, bootConfiguration.Metadata.Name, bootConfiguration, updateMetadata); err != nil {
		// Log the error but don't fail the request - events are non-critical
...
func PatchBootConfiguration(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourcePatched(r.Context(), "BootConfiguration", bootConfiguration.Metadata.UID, bootConfiguration.Metadata.Name, bootConfiguration, patchMetadata); err != nil {
		// Log the error but don't fail the request - events are non-critical
...
func UpdateBootConfigurationStatus(w http.ResponseWriter, r *http.Request) {
	...
	var statusUpdate v1.BootConfigurationStatus
	...
	if err := events.PublishResourceUpdated(r.Context(), "BootConfiguration", res.Metadata.UID, res.Metadata.Name, res, statusMetadata); err != nil {
...
func PatchBootConfigurationStatus(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourcePatched(r.Context(), "BootConfiguration", res.Metadata.UID, res.Metadata.Name, res, patchMetadata); err != nil {
...
func DeleteBootConfiguration(w http.ResponseWriter, r *http.Request) {
	...
	if err := events.PublishResourceDeleted(r.Context(), "BootConfiguration", bootConfiguration.Metadata.UID, bootConfiguration.Metadata.Name, deleteMetadata); err != nil {
		// Log the error but don't fail the request - events are non-critical
