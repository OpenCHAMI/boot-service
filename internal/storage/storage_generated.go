...
//
// Returns:
//   - []*v1.BMC: Slice of BMC resources
//   - error: Any error that occurred during loading
func LoadAllBMCs(ctx context.Context) ([]*v1.BMC, error) {
	ensureBackend()
	...
	bmcs := make([]*v1.BMC, 0, len(rawData))
...
func SaveBMC(ctx context.Context, bMC *v1.BMC) error {
	ensureBackend()
...
// Returns:
//   - error: fabricaStorage.ErrNotFound if resource doesn't exist, other errors for failures
func UpdateBMC(ctx context.Context, bMC *v1.BMC) error {
	ensureBackend()
...
//
// Returns:
//   - []*v1.BootConfiguration: Slice of BootConfiguration resources
//   - error: Any error that occurred during loading
func LoadAllBootConfigurations(ctx context.Context) ([]*v1.BootConfiguration, error) {
	ensureBackend()
	...
	bootconfigurations := make([]*v1.BootConfiguration, 0, len(rawData))
	for _, raw := range rawData {
...
//
// Returns:
//   - *v1.BootConfiguration: The BootConfiguration resource
//   - error: fabricaStorage.ErrNotFound if resource doesn't exist, other errors for failures
func LoadBootConfiguration(ctx context.Context, uid string) (*v1.BootConfiguration, error) {
	ensureBackend()
...
// Returns:
//   - error: Any error that occurred during saving
func SaveBootConfiguration(ctx context.Context, bootConfiguration *v1.BootConfiguration) error {
	ensureBackend()
...
// Returns:
//   - error: fabricaStorage.ErrNotFound if resource doesn't exist, other errors for failures
func UpdateBootConfiguration(ctx context.Context, bootConfiguration *v1.BootConfiguration) error {
	ensureBackend()
...
func (c *StorageClient) Get(ctx context.Context, kind, uid string) (interface{}, error) {
	...
	case "BootConfiguration":
		var resource v1.BootConfiguration
		if err := json.Unmarshal(rawData, &resource); err != nil {
			return nil, fmt.Errorf("failed to unmarshal BootConfiguration: %w", err)
		}
		return &resource, nil
